...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    ...
    return Product(
      ...
      salePrice: (json['variants'] as List?)?.isNotEmpty == true && (json['variants'][0]['sale_price'] != null)
         ? json['variants'][0]['sale_price'].toString()
         : null,
      imageUrl: imgUrl,
      slug: json['slug'] ?? '',
    );
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (product.salePrice != null && double.parse(product.salePrice!) > 0) ...[
                    Text(
                      '${formatter.format(double.parse(product.basePrice))} Br',
                      style: GoogleFonts.inter(
                        fontSize: 12,
                        fontWeight: FontWeight.w500,
                        color: Colors.grey,
                    ...
                    Text(
                      '${formatter.format(double.parse(product.salePrice!))} Br',
                      style: GoogleFonts.inter(
                        fontSize: 15,
