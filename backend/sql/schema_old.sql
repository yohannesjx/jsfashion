...
CREATE TABLE orders (
    ...
    payment_method VARCHAR(50), -- card, cash, gift_card, mixed
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE gift_cards (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    code VARCHAR(50) NOT NULL UNIQUE, -- Secure random string
    initial_balance DECIMAL(10, 2) NOT NULL,
    current_balance DECIMAL(10, 2) NOT NULL,
    currency VARCHAR(3) DEFAULT 'USD',
    status VARCHAR(50) DEFAULT 'active', -- active, used, expired, voided
...
CREATE TABLE gift_card_transactions (
    ...
    amount DECIMAL(10, 2) NOT NULL, -- Negative for usage, positive for refund/load
    type VARCHAR(50) NOT NULL, -- redemption, issuance, adjustment, refund
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);
