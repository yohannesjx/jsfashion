                                ...
                                <TableRow key={customer.id}>
                                    <TableCell>
                                        <div className="flex items-center gap-3">
                                            <div className="h-8 w-8 rounded-full bg-neutral-100 flex items-center justify-center text-neutral-500 font-bold text-xs">
                                    ...
                                    <TableCell>
                                        <div className="flex flex-col text-sm">
                                            ...
                                            <span className="text-neutral-500 text-xs">{customer.phone}</span>
                                        </div>
                                    </TableCell>
